namespace UnicomSGIP.Base
{
    ...
    /// SGIP命令格式和长度的定义
    /// </summary>
    public enum SGIPCommandDefine : uint
    {
        SGIP_BIND = 0x1,
        ...
        LEN_SGIP_HEADER = 20,
        LEN_SGIP_BIND = 41,
        LEN_SGIP_BIND_RESP = 9,
        LEN_SGIP_UNBIND = 0,
        LEN_SGIP_UNBIND_RESP = 0,
        LEN_SGIP_SUBMIT = 123,
        LEN_SGIP_SUBMIT_RESP = 9,
        ...
        LEN_SGIP_DELIVER = 57,
        LEN_SGIP_DELIVER_RESP = 9,
        LEN_SGIP_REPORT = 44,
        LEN_SGIP_REPORT_RESP = 9,
        LEN_SGIP_USERRPT = 51,
        LEN_SGIP_USERRPT_RESP = 9,
        LEN_SGIP_TRACE = 41,
        LEN_SGIP_TRACE_RESP = 48,
